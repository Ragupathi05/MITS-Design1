...
const Header = () => {
  ...
  return (
    ...
    >
      {/* Top bar - MITS Red background like official site ticker */}
      <div className="bg-primary text-primary-foreground/90 hidden md:block">
        <div className="container mx-auto px-4 h-9 flex items-center justify-between text-xs">
          <div className="flex items-center gap-4 lg:gap-6 whitespace-nowrap">
            <a href="#" className="hover:text-accent transition-colors font-medium">Student Portal</a>
            <a href="#" className="hover:text-accent transition-colors font-medium">Faculty Login</a>
            <a href="#" className="hover:text-accent transition-colors font-medium">ERP</a>
            <a href="tel:+918571280255" className="hover:text-accent transition-colors flex items-center gap-1.5">
              <Phone className="w-3.5 h-3.5" /> Admission Helpline
            </a>
            <a href="mailto:info@mits.ac.in" className="hover:text-accent transition-colors flex items-center gap-1.5">
              <Mail className="w-3.5 h-3.5" /> Email
            </a>
          </div>
          <div className="flex items-center gap-2">
            {[Facebook, Linkedin, Youtube].map((Icon, i) => (
              <a key={i} href="#" className="w-7 h-7 rounded-md bg-primary-foreground/10 hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-center">
      ...
      <div className={`transition-all duration-300 border-b ${
        scrolled
          ? "bg-white/98 backdrop-blur-md border-border shadow-sm"
