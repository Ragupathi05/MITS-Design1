...
export const psdSections: PsdSection[] = [
  {
    ...
    rows: [
      ...
      { subject: "Annual Reports", category: "Reports", actions: [ext("https://mits.ac.in/annual-reports")] },
      { subject: "Annual Accounts, Balance Sheet & Audit Report", category: "Financial", actions: [ext("https://mits.ac.in/audit-statements")] },
  ...
  },
  {
    ...
    category: "Governance",
    rows: [
      { subject: "Chancellor", details: "Dr. N. Vijaya Bhaskar Choudary", category: "Leadership", actions: [ext("https://mits.ac.in/chancellor")] },
      { subject: "Pro Chancellor", details: "Sri. N. Dwarakanath Naidu", category: "Leadership", actions: [ext("https://mits.ac.in/pro-chancellor")] },
      { subject: "Vice-Chancellor", details: "Dr. C. Yuvaraj", category: "Leadership", actions: [ext("https://mits.ac.in/vice-chancellor")] },
      { subject: "Registrar", details: "Dr. D. Pradeep Kumar", category: "Leadership", actions: [ext("https://mits.ac.in/registrar")] },
      { subject: "Principal (MITS Autonomous)", details: "Dr. P. Ramanathan", category: "Leadership", actions: [ext("https://mits.ac.in/principal")] },
      { subject: "Finance Officer", details: "Mr. Anil Kumar P", category: "Leadership", actions: [ext("https://mits.ac.in/finance-officer")] },
      { subject: "Controller of Examination", details: "Dr. V. Sai Kumar", category: "Leadership", actions: [ext("https://mits.ac.in/controller-of-examinations")] },
      { subject: "Ombudsperson", details: "Prof. K. Dasaratha Ramaiah", category: "Leadership", actions: [ext("https://mits.ac.in/ombudsperson")] },
      { subject: "Executive Council / Board of Governors", category: "Committees", actions: [int("/about/executive-council"), ext("https://mits.ac.in/assets/pdf/admin/Executive%20Council-Constitution-DTBU-2025.pdf")] },
      { subject: "Board of Management", details: "Ratakonda Ranga Reddy Educational Academy", category: "Committees", actions: [] },
      { subject: "Academic Council", category: "Committees", actions: [int("/about/academic-council"), ext("https://mits.ac.in/assets/pdf/admin/Academic%20Council%20Constitution%20DTBU.pdf")] },
      ...
      { subject: "Internal Complaint Committee", category: "Committees", actions: [ext("https://mits.ac.in/icc")] },
  ...
  },
  {
    ...
    rows: [
      ...
      { subject: "Statutes / Ordinances – Academics & Examinations", category: "Academic", actions: [ext("https://mits.ac.in/academic-regulations")] },
      { subject: "School of Engineering", category: "Schools", actions: [ext("https://mits.ac.in/school-of-engineering")] },
      { subject: "School of Computing", category: "Schools", actions: [ext("https://mits.ac.in/school-of-computing")] },
      { subject: "School of Management", category: "Schools", actions: [ext("https://mits.ac.in/school-of-management")] },
      { subject: "School of Artificial Intelligence", category: "Schools", actions: [ext("https://mits.ac.in/school-of-artificial-intelligence")] },
      ...
      { subject: "Internal Quality Assurance Cell (IQAC)", category: "Quality", actions: [ext("https://mits.ac.in/newiqac1")] },
      { subject: "Library", category: "Academic", actions: [int("/library")] },
      { subject: "Academic Collaborations", category: "Academic", actions: [ext("https://mits.ac.in/international-relations")] },
    ],
  },
  {
    id: "admissions-fee",
    ...
    rows: [
      ...
      { subject: "Fee Refund Policy", category: "Student", actions: [ext("https://mits.ac.in/refund-policy")] },
    ],
  },
  {
    id: "research",
    ...
    rows: [
      ...
      { subject: "Incubation Centre", category: "Research", actions: [ext("https://mits.ac.in/innovation-center")] },
      { subject: "Start-Up Cell (NISP)", category: "Research", actions: [ext("https://mits.ac.in/nisp")] },
      { subject: "Entrepreneurship Development Cell", category: "Research", actions: [ext("https://mits.ac.in/ed-cell")] },
  ...
  },
  {
    ...
    rows: [
      ...
      { subject: "NSS", category: "Student", actions: [ext("https://mits.ac.in/nss")] },
      { subject: "NCC", category: "Student", actions: [ext("https://mits.ac.in/ncc")] },
      ...
      { subject: "Student Grievance Redressal Committee (SGRC)", category: "Student", actions: [ext("https://mits.ac.in/grc")] },
      { subject: "Health Facilities", category: "Student", actions: [int("/infrastructure")] },
      { subject: "Internal Complaint Committee", category: "Student", actions: [ext("https://mits.ac.in/icc")] },
      { subject: "Anti-Ragging Cell", category: "Student", actions: [ext("https://mits.ac.in/anti-ragging")] },
      { subject: "Equal Opportunity Cell", category: "Student", actions: [ext("https://mits.ac.in/eofc")] },
      { subject: "Socio-Economically Disadvantaged Groups Cell (SEDG)", category: "Student", actions: [ext("https://mits.ac.in/sedg-cell")] },
  ...
  },
  {
    ...
    category: "Compliance",
    rows: [
      { subject: "RTI – CPIO and Appellate Authority", category: "Compliance", actions: [ext("https://mits.ac.in/cpio")] },
      ...
      { subject: "Newsletters", category: "Compliance", actions: [ext("https://mits.ac.in/newsletter")] },
      { subject: "News, Events & Achievements", category: "Compliance", actions: [int("/news-events")] },
      { subject: "Job Openings", category: "Compliance", actions: [ext("https://mits.ac.in/positionsoffered")] },
      { subject: "Reservation Roster", category: "Compliance", actions: [ext("https://mits.ac.in/reservation-roster")] },
      { subject: "Study in India", category: "Compliance", actions: [ext("https://studyinindia.gov.in/")] },
      { subject: "International Students – Admission Procedure", category: "Compliance", actions: [int("/admissions")] },
    ],
  },
  {
    id: "gallery",
