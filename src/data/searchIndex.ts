...
const coreWebsiteItems: SearchItem[] = [
  ...
  },
  {
    ...
    category: "Admissions & Fees",
    description: "Tuition fees for B.Tech, PG courses, hostel fees, scholarships, merit incentives, and installment details.",
    href: "/eligibility-and-fees",
    tags: ["fees", "fee structure", "tuition fee", "cost", "eligibility", "scholarship", "scholarships", "concession", "hostel fee", "payment"],
    metaBadge: "Fees & Aid",
  },
  {
  ...
  },
  {
    ...
    category: "Campus Life & Facilities",
    description: "Separate boys and girls residential hostels, hygienic dining mess, 24/7 security, Wi-Fi, and solar water heating.",
    href: "/hostels",
    tags: ["hostels", "hostel", "boys hostel", "girls hostel", "accommodation", "mess", "dining", "room", "boarding", "stay"],
    metaBadge: "Hostels",
  },
  {
    id: "campus-sports",
...
const synonymMap: Record<string, string[]> = {
  ...
  hostel: ["hostels", "mess", "dining", "room", "accommodation", "dorm"],
  hostels: ["hostel", "mess", "dining", "room", "accommodation", "dorm"],
