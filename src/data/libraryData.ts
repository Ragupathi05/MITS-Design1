...
export const libraryStats: LibStat[] = [
  { key: "titles", label: "Book Titles", value: 11104, note: "Incl. 597 complimentary & donated" },
  { key: "volumes", label: "Total Volumes", value: 64600 },
  { key: "reference", label: "Reference Books", value: 10507 },
  { key: "ebooks", label: "E-Books", value: 4200, note: "DELNET 1,000 + NDL 3,200" },
  { key: "ejournals", label: "E-Journals", value: 2505, note: "IEEE, Springer, EBSCO" },
  ...
  { key: "newspapers", label: "Newspapers", value: 15, note: "10 Telugu + 5 English" },
...
export const digitalResources: DigitalResource[] = [
  ...
  { name: "INFLIBNET N-LIST", desc: "e-Shodh Sindhu — access to thousands of scholarly e-journals and e-books.", category: "Network", href: "https://nlist.inflibnet.ac.in/" },
  { name: "Knimbus", desc: "Cloud-based remote access to all library digital resources from anywhere.", category: "Platform", href: "https://www.knimbus.com/" },
...
export const memberships = [
  ...
  { title: "INFLIBNET N-LIST", id: "e-Shodh Sindhu", desc: "National Library and Information Services Infrastructure." },
...
export const facilities = [
  { title: "Digital Library", desc: "30 dedicated systems with high-speed internet access." },
  ...
  { title: "Remote Access", desc: "Access e-resources off-campus via Knimbus platform." },
];
...
export const collections = [
  { title: "Books", value: "64,600 vols" },
  { title: "Reference Books", value: "10,507" },
  { title: "Journals", value: "136 print + 2,505 e-journals" },
  { title: "Magazines", value: "14 titles" },
  { title: "Newspapers", value: "15 dailies" },
  { title: "Project Reports", value: "5,009" },
  { title: "CD-ROM Collection", value: "2,002" },
  { title: "Digital Content", value: "4,200+ e-books" },
...
export const quickAccess = [
  ...
  { title: "N-LIST", href: "https://nlist.inflibnet.ac.in/" },
