          ...
          <div className="space-y-6" id="general-policy">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  ...
                  <div key={idx} className="bg-slate-50 border border-slate-200/60 p-5 rounded-xl flex items-start gap-4 hover:bg-slate-100/50 transition-colors duration-200">
                    <span className="w-7 h-7 rounded-full bg-[#0f2a44] text-[#caa74d] flex items-center justify-center font-bold text-xs shrink-0 border border-[#caa74d]/30 shadow-sm">{idx + 1}</span>
                    <div className="space-y-1">
                      <h4 className="font-bold text-[#0f2a44] text-sm md:text-base">{s.step}</h4>
                      <p className="text-xs md:text-sm text-slate-550 leading-relaxed font-sans">{s.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="p-6 border-slate-200 shadow-md bg-white relative overflow-hidden group hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-xs md:text-sm text-slate-500 pl-2 leading-relaxed font-sans">
                ...
                <table className="w-full border-collapse text-left text-xs md:text-sm">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-[#0f2a44] border border-slate-200 text-xs md:text-sm">B.Tech</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">
                        10+2 with Physics, Mathematics, Chemistry (Min. 50% aggregate).<br />
                        <span className="text-[11px] md:text-xs text-slate-400 font-semibold block mt-1">10+2 with Physics, Chemistry, Biology (PCB) is acceptable for B.Tech in Bioinformatics.</span>
                      </td>
                      <td className="py-3 px-4 font-semibold text-slate-700 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">MITSUCET, JEE, National Level Entrance tests, State level Entrance tests, 10+2 Merit</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-[#0f2a44] border border-slate-200 text-xs md:text-sm">BBA &amp; BCA</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">10+2 in any stream (Min. 50% aggregate).</td>
                      <td className="py-3 px-4 font-semibold text-slate-700 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">MITSUCET, 10+2 Merit</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-[#0f2a44] border border-slate-200 text-xs md:text-sm">MBA</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">Bachelor's Degree of minimum 3 years duration (Min. 50% aggregate).</td>
                      <td className="py-3 px-4 font-semibold text-slate-700 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">National Level Entrance tests, CAT, MAT, State level Entrance tests, MITSUCET, UG Merit</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-[#0f2a44] border border-slate-200 text-xs md:text-sm">MCA</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">BCA/Bachelor Degree in Comp. Sci. OR B.Sc/B.A./B.Com with Math at 10+2 or Undergraduate level (Min. 50%).</td>
                      <td className="py-3 px-4 font-semibold text-slate-700 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">NIMCET, State level Entrance tests, MITSUCET, UG Merit</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-[#0f2a44] border border-slate-200 text-xs md:text-sm">M.Tech</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">B.E./B.Tech in relevant discipline (Min. 50% aggregate).</td>
                      <td className="py-3 px-4 font-semibold text-slate-700 border border-slate-200 leading-relaxed text-xs md:text-sm font-sans">GATE, State level Entrance tests, UG Merit</td>
                    </tr>
                  </tbody>
                </table>
              </div>

              <div className="bg-slate-50 border-l-4 border-[#b31317] rounded-r-xl p-4 text-xs md:text-sm text-slate-600 leading-relaxed font-sans">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-md p-6 md:p-8 space-y-6">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-200 bg-white">
                <table className="w-full border-collapse text-left text-xs md:text-sm">
                  ...
                  <tbody className="divide-y divide-slate-200 text-slate-700 font-medium">
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-slate-800 border border-slate-200 text-xs md:text-sm">Category B</td>
                      <td className="py-3 px-4 border border-slate-200 text-xs md:text-sm">10% of Total Intake</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 font-normal leading-relaxed text-xs md:text-sm font-sans">Management Quota: Candidates satisfying basic qualifying exam eligibility are exempt from the entrance exam requirement.</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 font-bold text-slate-800 border border-slate-200 text-xs md:text-sm" rowSpan={5}>Category A (General Merit Quota)</td>
                      <td className="py-3 px-4 border border-slate-200 text-[#0f2a44] font-bold text-xs md:text-sm">90% of Total Intake</td>
                      <td className="py-3 px-4 text-slate-600 border border-slate-200 font-normal leading-relaxed text-xs md:text-sm font-sans">Divided strictly into sub-quotas as detailed below:</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 bg-slate-50/30 transition-colors duration-150">
                      <td className="py-2.5 px-6 border border-slate-200 font-semibold text-slate-800 text-[11px] md:text-xs">└ Sub-Quota A1 (25%)</td>
                      <td className="py-2.5 px-5 text-slate-550 border border-slate-200 font-normal leading-relaxed text-[11px] md:text-xs font-sans">National Level Exams: JEE Main (B.Tech), CAT/MAT (MBA), NIMCET (MCA), GATE (M.Tech).</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 bg-slate-50/30 transition-colors duration-150">
                      <td className="py-2.5 px-6 border border-slate-200 font-semibold text-slate-800 text-[11px] md:text-xs">└ Sub-Quota A2 (45%)</td>
                      <td className="py-2.5 px-5 text-slate-550 border border-slate-200 font-normal leading-relaxed text-[11px] md:text-xs font-sans">University Exam: MITSUCET (Proctored CBT or PBT).</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 bg-slate-50/30 transition-colors duration-150">
                      <td className="py-2.5 px-6 border border-slate-200 font-semibold text-slate-800 text-[11px] md:text-xs">└ Sub-Quota A3 (10%)</td>
                      <td className="py-2.5 px-5 text-slate-550 border border-slate-200 font-normal leading-relaxed text-[11px] md:text-xs font-sans">State Level Exams: State CET (B.Tech), State ICET (MBA/MCA).</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 bg-slate-50/30 transition-colors duration-150">
                      <td className="py-2.5 px-6 border border-slate-200 font-semibold text-slate-800 text-[11px] md:text-xs">└ Sub-Quota A4 (10%)</td>
                      <td className="py-2.5 px-5 text-slate-550 border border-slate-200 font-normal leading-relaxed text-[11px] md:text-xs font-sans">Merit/Qualifying Exam: 10+2 equivalent (UG) or Bachelor's Degree (PG).</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="bg-[#fffcf3] border border-amber-200 rounded-xl p-5 flex items-start gap-4 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs md:text-sm text-[#785310]/80 leading-relaxed font-sans">
                    To ensure maximum seat occupancy, vacant seats in any sub-quota automatically cascade to the next in the sequence:
                  </p>
                  <div className="inline-flex items-center gap-2 bg-[#785310] text-white text-[11px] md:text-xs font-extrabold px-4 py-1.5 rounded-full mt-1 shadow-sm">
          ...
          <div className="space-y-6" id="lateral-entry">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-md p-6 md:p-8 space-y-6">
              <div className="flex flex-wrap gap-2.5">
                <Badge className="bg-[#0f2a44] text-white text-xs px-3 py-1">Applicable Programs: B.Tech (All Branches)</Badge>
                <Badge className="bg-[#caa74d] text-[#0f2a44] text-xs px-3 py-1">Entry Level: Second Year (3rd Semester)</Badge>
              </div>
              ...
              <ul className="space-y-2.5 pl-1 text-slate-500 text-xs md:text-sm font-sans">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                <div className="border border-slate-200 p-5 rounded-xl bg-white shadow-sm hover:border-[#caa74d] transition-colors duration-200">
                  ...
                  <p className="text-slate-500 text-xs md:text-sm leading-relaxed mt-2 font-sans">
                    ...
                    <span className="text-[11px] md:text-xs text-red-650 font-semibold block mt-2.5 bg-red-50/50 p-2.5 rounded-lg border border-red-100">Note: B.Sc. stream students shall clear Engineering Graphics / Drawing and Engineering Mechanics of the 1st year along with 2nd year subjects.</span>
                  </p>
                </div>
              </div>
                ...
                <table className="w-full border-collapse text-left text-xs md:text-sm">
                  ...
                  <tbody className="divide-y divide-slate-200 font-medium text-slate-700">
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      ...
                      <td className="py-3 px-4 border border-slate-200 font-bold text-slate-800 text-xs md:text-sm">Management Quota</td>
                      <td className="py-3 px-4 border border-slate-200 text-xs md:text-sm">20% of Total LE Intake</td>
                      <td className="py-3 px-4 text-slate-550 border border-slate-200 font-normal leading-relaxed text-xs md:text-sm font-sans">Exempt from entrance exam mandate; satisfying basic diploma qualifying criteria.</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 text-center border border-slate-200 font-bold">2</td>
                      <td className="py-3 px-4 border border-slate-200 font-bold text-slate-800 text-xs md:text-sm">Entrance Exam Merit Quota</td>
                      <td className="py-3 px-4 border border-slate-200 text-xs md:text-sm">40% of Total LE Intake</td>
                      <td className="py-3 px-4 text-slate-550 border border-slate-200 font-normal leading-relaxed text-xs md:text-sm font-sans">Ranked strictly based on performance in recognized State Level Lateral Entry Exams (e.g. AP ECET) or the University Entrance Exam.</td>
                    </tr>
                    <tr className="hover:bg-slate-50/50 transition-colors duration-150">
                      <td className="py-3 px-4 text-center border border-slate-200 font-bold">3</td>
                      <td className="py-3 px-4 border border-slate-200 font-bold text-slate-800 text-xs md:text-sm">Diploma Merit Quota</td>
                      <td className="py-3 px-4 border border-slate-200 text-xs md:text-sm">40% of Total LE Intake</td>
                      <td className="py-3 px-4 text-slate-550 border border-slate-200 font-normal leading-relaxed text-xs md:text-sm font-sans">Ranked strictly based on the academic merit (aggregate percentage) achieved in the qualifying Engineering Diploma.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-5 pt-2">
                <div className="bg-[#fffcf3] border border-amber-200 rounded-xl p-5 shadow-sm">
                  ...
                  <p className="text-xs md:text-sm text-[#785310]/80 mt-1.5 leading-relaxed font-sans">
        ...
        <ScrollReveal>
          <div className="space-y-6" id="refund-policy">
            ...
            <Card className="p-6 md:p-8 border-slate-200 shadow-md bg-white relative overflow-hidden rounded-2xl hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-slate-655 leading-relaxed text-xs md:text-sm font-sans">
