        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal direction="right" delay={0.2}>
            <div className="relative group">
              <img src={`${BASE}Hero-Section/image%202.JPG`} alt="MITS Campus Building" className="rounded-lg shadow-xl w-full group-hover:shadow-2xl transition-all duration-300" />
