...
const FALLBACK_DATA: Record<string, CMSContent> = {
  cse: {
    events: [
      { id: "e1", department: "cse", title: "International Conference on AI and Data Science (ICADS 2024)", date: "March 15–16, 2024", description: "Two-day international conference bringing together researchers in Artificial Intelligence, Machine Learning, and Data Science.", venue: "MITS, Madanapalle", type: "Conference" },
    ...
    news: [
      { id: "n1", department: "cse", title: "CSE Department Receives NBA Accreditation for 2024–2027", date: "January 2024", content: "The Department of Computer Science and Engineering has received NBA accreditation for the next three years, recognizing its commitment to quality education.", category: "Accreditation" },
