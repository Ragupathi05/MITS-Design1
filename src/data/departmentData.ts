...
export const departmentsData: Record<string, DepartmentData> = {
  ...
  ce: {
    ...
    nbaAccredited: true,
    hod: { name: "Dr. S. Srinivasa Rao", designation: "Professor & Head", qualification: "Ph.D. (Civil Engineering)" },
    ...
    faculty: [
      { name: "Dr. S. Srinivasa Rao", designation: "Professor & Head", qualification: "Ph.D." },
      { name: "Dr. K. Venkata Reddy", designation: "Associate Professor", qualification: "Ph.D." },
      { name: "Mr. P. Naveen Kumar", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. G. Swathi", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. D. Suresh Babu", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. K. Prasad", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. R. Kavitha", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. M. Krishna", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. S. Venkatesh", designation: "Assistant Professor", qualification: "M.Tech" },
    ],
    detailedAchievements: [
  ...
  aiml: {
    ...
    nbaAccredited: false,
    hod: { name: "Dr. T. Ravi Kumar", designation: "Professor & Head", qualification: "Ph.D. (CSE/AI)" },
    ...
    contactInfo: { email: "hod_aiml@mits.ac.in", phone: "+91-8571-280255" },
    faculty: [
      { name: "Dr. T. Ravi Kumar", designation: "Professor & Head", qualification: "Ph.D." },
      { name: "Dr. L. Nagaraju", designation: "Associate Professor", qualification: "Ph.D." },
      { name: "Mr. K. Siva Ram", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. P. Deepika", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. A. Venkatesh", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. S. Keerthi", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. R. Manoj", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. N. Anuradha", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. V. Karthik", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. G. Sravanthi", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mr. D. Srikanth", designation: "Assistant Professor", qualification: "M.Tech" },
      { name: "Mrs. K. Mounika", designation: "Assistant Professor", qualification: "M.Tech" },
    ],
    detailedAchievements: [
